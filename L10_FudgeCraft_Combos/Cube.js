...
(function (L10_FudgeCraft_Combos) {
    ...
    (function (CUBE_TYPE) {
        ...
        CUBE_TYPE["CYAN"] = "Cyan";
        CUBE_TYPE["GREY"] = "Grey";
    })(CUBE_TYPE = L10_FudgeCraft_Combos.CUBE_TYPE || (L10_FudgeCraft_Combos.CUBE_TYPE = {}));
    class Cube extends ƒ.Node {
        ...
        static createMaterials() {
            return new Map([
                ...
                [CUBE_TYPE.GREY, new ƒ.Material(CUBE_TYPE.GREY, ƒ.ShaderFlat, new ƒ.CoatColored(ƒ.Color.CSS("LightGrey")))]
            ]);
        }
    }
