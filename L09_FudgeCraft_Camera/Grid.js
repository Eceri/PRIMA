...
(function (L09_FudgeCraft_Camera) {
    ...
    class Grid extends Map {
        ...
        constructor() {
            super();
            this.push(L09_FudgeCraft_Camera.ƒ.Vector3.ZERO(), new GridElement(new L09_FudgeCraft_Camera.Cube(L09_FudgeCraft_Camera.CUBE_TYPE.GREY, L09_FudgeCraft_Camera.ƒ.Vector3.ZERO())));
        }
