...
(function (L09_FudgeCraft_Camera) {
    ...
    function hndLoad(_event) {
        ...
        let cmpLight = new L09_FudgeCraft_Camera.ƒ.ComponentLight(new L09_FudgeCraft_Camera.ƒ.LightDirectional(L09_FudgeCraft_Camera.ƒ.Color.CSS("White")));
        cmpLight.pivot.lookAt(new L09_FudgeCraft_Camera.ƒ.Vector3(0.5, 1, 0.8));
        L09_FudgeCraft_Camera.game.addComponent(cmpLight);
        let cmpLightAmbient = new L09_FudgeCraft_Camera.ƒ.ComponentLight(new L09_FudgeCraft_Camera.ƒ.LightAmbient(L09_FudgeCraft_Camera.ƒ.Color.CSS("DarkGrey")));
